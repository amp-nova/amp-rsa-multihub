...
var commerceBackendKeyPrefixes = ['bigcommerce', 'hybris', 'commercetools'];
var backendKeys = [];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (key) {
                    backendKeys = [_.find(backendKeys, function (k) { return key === k; })];
                }
                backendKeys = _.filter(backendKeys, function (bk) { return _.indexOf(commerceBackendKeyPrefixes, bk.split('/')[0]) > -1; });
                return [4 /*yield*/, Promise.all(backendKeys.map(function (backendKey) { return __awaiter(void 0, void 0, void 0, function () {
                        var log, client, _a, type, key, mapped, flattenCategories, results, products, product, topLevelCategories, secondLevelCategories, thirdLevelCategories, category, _b, _c, _d;
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                case 0:
                                    log = '';
                                    log += "Testing backend [ " + chalk.green(backendKey) + " ]\n";
                                    client = new client_1.PbxCommerceClient(graphqlUrl, backendKey);
                                    ...
                                    results = {};
                                    if (!(_.indexOf(commerceBackendKeyPrefixes, type) > -1)) return [3 /*break*/, 6];
                                ...
                                case 2:
                                    ...
                                    _b = results;
                                    return [4 /*yield*/, client.getCategory(new types_1.QueryContext({ id: category.id }))];
                                case 3:
                                    _b.categoryById = _e.sent();
                                    _c = results;
                                    return [4 /*yield*/, client.getProduct(new types_1.QueryContext({ id: product.id }))];
                                case 4:
                                    _c.productById = _e.sent();
                                    _d = results;
                                    return [4 /*yield*/, client.getCategory(new types_1.QueryContext({ slug: category.slug }))];
                                case 5:
            ...
            case 2:
                ...
                _.each(results, function (result) {
                    ...
                    console.log();
                    console.log("    lookup category [ id: " + chalk.yellow(result.categoryById.id) + " ]...[ " + chalk.green('pass') + " ]");
                    console.log("    lookup category [ slug: " + chalk.yellow(result.categoryBySlug.slug) + " ]...[ " + chalk.green('pass') + " ]");
                    console.log("    lookup product  [ id: " + chalk.yellow(result.productById.id) + " ]...[ " + chalk.green('pass') + " ]");
                });
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
