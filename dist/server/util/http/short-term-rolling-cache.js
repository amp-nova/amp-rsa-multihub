...
var cache = {};
var timer = function (url, seconds) {
...
module.exports = function (seconds) { return function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, x;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [3 /*break*/, 4];
            case 1:
                if (!cache[request.url]) return [3 /*break*/, 2];
            ...
            case 3:
                ...
                return [2 /*return*/, x];
            case 4: return [4 /*yield*/, axios_1.default(request)];
            case 5: 
