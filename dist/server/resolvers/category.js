...
var CategoryResolver = /** @class */ (function () {
    ...
    CategoryResolver.prototype.category = function (args, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ctx.commercehub.getCategory(args)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CategoryResolver.prototype.categoryHierarchy = function (args, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ctx.commercehub.getCategoryHierarchy(args)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CategoryResolver.prototype.products = function (parent, args, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ctx.commercehub.getProductsForCategory(parent, args)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
...
module.exports = { CategoryResolver: CategoryResolver };
