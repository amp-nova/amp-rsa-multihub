...
var VariantResolver = /** @class */ (function () {
    ...
    VariantResolver.prototype.attribute = function (variant, args) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, lodash_1.default.get(lodash_1.default.find(variant.attributes, function (att) { return att.name.toLowerCase() === args.name.toLowerCase(); }), 'value')];
            });
        });
    };
    VariantResolver.prototype.defaultImage = function (variant) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, lodash_1.default.first(variant.images)];
            });
        });
    };
    __decorate([
        type_graphql_1.FieldResolver(function (returns) { return String; }, { nullable: true }),
...
module.exports = { VariantResolver: VariantResolver };
